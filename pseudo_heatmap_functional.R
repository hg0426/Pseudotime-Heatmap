source("function_pseudo_heatmap.r.R")
...
pseudotime_heatmap(matrix = sample_matrix,gene_list = sample_gene_list,pseudotime = sample_pseudotime,
...
confirm <- pseudotime_heatmap_for_confirm(matrix = sample_matrix,gene_list = sample_gene_list,
                                          pseudotime = sample_pseudotime,span = 0.6,use_pseudotime_origin = F,
                                          use_z_score = T,order_pseudo_score = F)
